...
# Define paths
AD_CUSTOMS_FOLDER="/Users/karthik/Projects/Github/doc-agent-policy/Docs/AD_Customs"
OUTPUT_DIR="Output"
...
# Step 2: Run smart chunking agent on AD_Customs folder
echo "Running b_smart_chunking_agent.py on AD_Customs folder..."
# Without the --force flag, it will skip already processed files
python b_smart_chunking_agent.py --input "$AD_CUSTOMS_FOLDER" --output "$OUTPUT_DIR"
