...
# Define paths
DCT_FOLDER="/Users/karthik/Projects/Github/doc-agent-policy/Docs/DCT"
OUTPUT_DIR="Output"
...
# Step 2: Run smart chunking agent on DCT folder
echo "Running b_smart_chunking_agent.py on DCT folder..."
# Without the --force flag, it will skip already processed files
python b_smart_chunking_agent.py --input "$DCT_FOLDER" --output "$OUTPUT_DIR"
